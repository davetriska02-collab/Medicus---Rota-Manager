...
import { demoData, demoOverviewPayload } from './shared/demo.js';
      ...
      schedule: [
        {
          ...
          entries: [
            { diaryEntryType: { value: 'appointment' }, startDateTime: '2026-06-10T09:00:00', displayStatus: { value: 'booked' } },
            { diaryEntryType: { value: 'appointment' }, startDateTime: '2026-06-10T09:10:00', displayStatus: { value: 'cancelled' } },
            { diaryEntryType: { value: 'slot' }, startDateTime: '2026-06-10T09:20:00' },
            { diaryEntryType: { value: 'appointment' }, startDateTime: '2026-06-10T14:00:00', displayStatus: { value: 'arrived' } }
          ]
        },
        {
...
let findings = diffDay({
  date: '2026-06-10', medicusRows: rows, staff: [gp, gp2], leaveList: [],
  rotaEntries: [
...
findings = diffDay({
  date: '2026-06-10', medicusRows: rows, staff: [gp],
...
findings = diffDay({
  date: '2026-06-10', medicusRows: rows, staff: [gpCase], leaveList: [],
...
const demoFindings = diffDay({ date: '2026-06-10', medicusRows: demoRows, staff: demo.staff, leaveList: [], rotaEntries: [] });
