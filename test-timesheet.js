...
import { buildTimesheet, timesheetCSV } from './engine/timesheet.js';
import { toilBalance } from './engine/leave.js';
...
const leaveList = [
  { id: 'l1', staffId: 'g1', type: 'annual', status: 'approved', startDate: '2026-06-10', endDate: '2026-06-11', sessions: 4 },
  { id: 'l2', staffId: 'g1', type: 'annual', status: 'requested', startDate: '2026-06-20', endDate: '2026-06-21', sessions: 4 } // not approved
];
...
const toilLeave = [
  { id: 't1', staffId: 'n1', type: 'toil', status: 'approved', startDate: '2026-05-01', endDate: '2026-05-01', sessions: 2 },
  { id: 't2', staffId: 'n1', type: 'toil', status: 'requested', startDate: '2026-06-01', endDate: '2026-06-01', sessions: 2 }
];
