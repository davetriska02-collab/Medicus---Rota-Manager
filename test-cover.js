...
const vacancy = { id: 'v1', staffId: 'sick', date: '2026-06-08', period: 'am', typeId: 'surgery', status: 'vacancy', roomId: 'r9' };
const entries = [
  vacancy,
...
const leaveList = [{ staffId: 'away', type: 'annual', status: 'approved', startDate: '2026-06-08', endDate: '2026-06-08' }];
...
assert.deepEqual(ranked.map((c) => c.staffId), ['spare', 'full', 'loc']);
...
assert.deepEqual(dutyRanked.map((c) => c.staffId), ['spare']);
