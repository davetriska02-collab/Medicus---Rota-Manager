...
import { sicknessEpisodes, bradfordScore, bradfordRows } from './engine/bradford.js';
...
let r = bradfordScore({
  person, settings, asOf: '2026-06-10',
...
r = bradfordScore({
  person, asOf: '2026-06-10', leaveList: fourEpisodes,
